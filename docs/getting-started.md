...
<!-- cSpell:word libc, libg, libm, libcxx, libfreetype -->
<!-- cSpell:word uchan, mikan, mikanos, osbook, tview, Nasm, devenv, iasl, newlib, edksetup, freetype, distutils, buildenv  -->
...
NOTE: When executing the above commands, I encountered the following errors.
